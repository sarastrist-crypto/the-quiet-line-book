  ...
  return (
    <div className="site-wrapper">
        ...
        <div className="container grid-2">
          <div className="hero-text">
            ...
            <div className="hero-ctas">
              <a
                href="https://readthequietlinebook.com/"
                target="_blank"
        ...
        <div className="container container-narrow">
          ...
          <div className="faq-list">
            ...
            <details>
              ...
              <div className="faq-ans"><strong>Kindle:</strong> available now on Amazon. <strong>Paperback:</strong> coming soon &mdash; sign up below to be notified the day it ships. <strong>Audiobook:</strong> in production. <strong>Hardcover:</strong> down the road.</div>
            </details>
            <details>
        ...
        <div className="container">
          <div className="capture-card">
            <div className="capture-text">
              ...
              <p>The 22-page opening chapter, delivered as a PDF to your inbox in under a minute. No follow-up sequence. I value your inbox as much as my own. You&rsquo;ll also get a single note the day the paperback ships.</p>
            </div>
      ...
      <style>{`
        ...
        .amazon-btn:hover .amazon-logo {
          transform: scale(1.1) rotate(-5deg);
        }

        /* May campaign: demote Amazon, elevate Paperback */
        .amazon-wrapper {
          display: flex;
          flex-direction: column;
        ...
        .amazon-demoted::after {
          ...
          background: linear-gradient(
            ...
            var(--accent-primary) calc(50% - 0.5px),
            var(--accent-primary) calc(50% + 0.5px),
            transparent calc(50% + 1px)
          );
          pointer-events: none;
