...
**Mono dash bullet**: every list item carries an em-dash (`U+2014`) in mono gold as the bullet marker, with a 1.2em column for the marker and 0.5em gap.
...
- **The em-dash bullet (`U+2014` in mono gold) translates perfectly**: em-dash bullets are equally idiomatic in Chinese typography.
