...
**Bullet em-dash**: A `U+2014` glyph in JetBrains Mono colored `{colors.ink-graphite-light}`, prepended to each list item via a CSS grid marker column (`grid-template-columns: 1.2em 1fr`).
...
The em-dash bullet marker (`U+2014`) works perfectly in Chinese, the Chinese em-dash is also `U+2014` and renders the same width. Keep the marker as-is.
