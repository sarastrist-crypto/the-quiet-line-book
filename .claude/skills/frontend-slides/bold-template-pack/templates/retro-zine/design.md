...
- **Caveat** (hand-script): A casual handwritten cursive. Used at weights 400–700 for author attributions (an em-dash prefixed attribution such as "Our founding principle since day one"), side notes, decorative captions on display elements, value-fills in RSVP-style form layouts. Provides warmth and a human-hand voice against the otherwise typeset system.
