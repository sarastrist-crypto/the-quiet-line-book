...
**Bullet em-dash**: The list marker for every bullet list. Renders as `U+2014` in DM Mono colored warm orange, prepended to the list item via the marker column of a CSS grid (`grid-template-columns: 1.4em 1fr`). The bullet voice of the system.
